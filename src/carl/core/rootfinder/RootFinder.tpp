...
boost::optional<std::vector<RealAlgebraicNumber<Number>>> realRoots(const UnivariatePolynomial<Coeff>& poly,
                                                                    const std::map<Variable, RealAlgebraicNumber<Number>>& varToRANMap,
                                                                    const Interval<Number>& interval, SplittingStrategy pivoting) {
...
template<typename Coeff, typename Number>
boost::optional<std::vector<RealAlgebraicNumber<Number>>> realRoots(const UnivariatePolynomial<Coeff>& poly, const std::list<Variable>& variables,
                                                                    const std::list<RealAlgebraicNumber<Number>>& values, const Interval<Number>& interval,
