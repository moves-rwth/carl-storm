...
template<>
inline bool scale(int exp, cln::cl_I& r, cln::cl_I rin) {
    if (exp >= 0)
...
template<>
inline bool scale(int exp, cln::cl_RA& r, cln::cl_RA rin) {
    if (exp >= 0)
...
#else
template<>
inline void scale(int exp, cln::cl_I& r) {
    if (exp >= 0)
...
template<>
inline bool is_equal_to_one(const cln::cl_I& value) {
