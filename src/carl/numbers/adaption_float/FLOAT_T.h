...
class FLOAT_T {
   ...
   public:
     ...
     */
    explicit FLOAT_T(double _double, CARL_RND /*unused*/ = CARL_RND::N) : mValue(carl::convert<double, FloatType>(_double)) {}
     ...
     * @param N Possible rounding direction.
     */
    explicit FLOAT_T(sint _int, CARL_RND /*unused*/ = CARL_RND::N) : mValue(FloatType(_int)) {}

    explicit FLOAT_T(int _int, CARL_RND /*unused*/ = CARL_RND::N) : mValue(FloatType(_int)) {}
     ...
     * @param N Possible rounding direction.
     */
    explicit FLOAT_T(unsigned _int, CARL_RND /*unused*/ = CARL_RND::N) : mValue(FloatType(_int)) {}
    ...
    FLOAT_T(FLOAT_T&& _float, CARL_RND /*unused*/ = CARL_RND::N) noexcept
        : mValue(std::move(_float.value()))  // NOLINT
    {}
    ...
    explicit FLOAT_T(FloatType val, CARL_RND /*unused*/ = CARL_RND::N) : mValue(std::move(val)) {}

    template<typename F = FloatType, EnableIf<carl::is_rational<F>> = dummy>
    explicit FLOAT_T(const std::string& _string, CARL_RND /*unused*/ = CARL_RND::N) : mValue(carl::rationalize<FloatType>(_string)) {}

    template<typename F = FloatType, EnableIf<std::is_same<F, double>> = dummy>
    explicit FLOAT_T(const std::string& _string, CARL_RND /*unused*/ = CARL_RND::N) : mValue(std::stod(_string)) {}
...
class numeric_limits<carl::FLOAT_T<Number>> {
   public:
    ...
    inline static carl::FLOAT_T<Number>(min)() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::min());
    }
    inline static carl::FLOAT_T<Number>(max)() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::max());
    }
    inline static carl::FLOAT_T<Number> lowest() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::lowest());
    }

    inline static carl::FLOAT_T<Number> epsilon() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::epsilon());
    }

    inline static carl::FLOAT_T<Number> round_error() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::round_error());
    }

    inline static const carl::FLOAT_T<Number> infinity() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::infinity());
    }

    inline static const carl::FLOAT_T<Number> quiet_NaN() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::quiet_NaN());
    }
    inline static const carl::FLOAT_T<Number> signaling_NaN() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::signaling_NaN());
    }
    inline static const carl::FLOAT_T<Number> denorm_min() {
        return carl::FLOAT_T<Number>(std::numeric_limits<Number>::denorm_min());
    }
