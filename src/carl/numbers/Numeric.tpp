 ...
 */
template<typename T>
Numeric<T>::Numeric(ContentType _value, bool is_definitely_int) : mContent(is_definitely_int || IS_INT(_value) ? _value : allocate(_value)) {}
 ...
 */
template<typename T>
Numeric<T>::Numeric(const Numeric<T>& _value) : mContent(IS_INT(_value.mContent) ? _value.mContent : allocate(_value.rational())) {}
