...
template<>
inline bool scale(int exp, mpz_class& n, mpz_class acc_n) {
    if (exp >= 0)
...
template<>
inline bool scale(int exp, mpq_class& n, mpq_class acc_n) {
    if (exp >= 0)
...
#else
template<>
inline void scale(int exp, mpz_class& n) {
    if (exp >= 0)
...
template<>
inline bool is_equal_to_one(const mpz_class& value) {
