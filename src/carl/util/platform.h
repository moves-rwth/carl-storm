...
#define CLANG_WARNING_DISABLE(warning)                                                         \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wunknown-pragmas\"") \
        _Pragma("clang diagnostic ignored \"-Wunknown-warning-option\"") _Pragma(STRINGIFY(clang diagnostic ignored warning))
