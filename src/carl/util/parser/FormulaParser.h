...
struct FormulaParser : public qi::grammar<Iterator, Formula<Pol>(), Skipper> {
    FormulaParser() : FormulaParser<Pol>::base_type(main, "formula"), varmap(), binaryop(), naryop(), varname(), variable(), formula_op(), formula(), main() {
        ...
        formula = (variable[qi::_val = px::construct<Formula<Pol>>(qi::_1)]) | ("(" >> formula_op > ")")[qi::_val = qi::_1]
