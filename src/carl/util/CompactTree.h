...
template<class E, bool FI>
CompactTree<E, FI>::CompactTree(size_t initialCapacity) : _array(static_cast<E*>(nullptr) - 1), _lastLeaf(0), _capacityEnd(Node(0).next(initialCapacity)) {
...
template<class E, bool FI>
CompactTree<E, FI>::CompactTree(const CompactTree& tree, size_t minCapacity) : _array(static_cast<E*>(0) - 1), _lastLeaf(tree._lastLeaf) {
