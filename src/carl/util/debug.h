 ...
 * The signal handler uses the data in last_assertion_string and last_assertion_code to generate an additional message and a custom exit code whenever an
 * assertion is thrown. As for last_assertion_code the line number of the usage of this macro is used.
 *
