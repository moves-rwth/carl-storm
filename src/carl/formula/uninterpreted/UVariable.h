...
class UVariable {
   ...
   public:
     ...
     */
    UVariable() : mVar(Variable::NO_VARIABLE), mDomain() {}

    explicit UVariable(Variable var) : mVar(var), mDomain(SortManager::getInstance().getInterpreted(var.type())) {}
     ...
     */
    UVariable(Variable _var, Sort _domain) : mVar(_var), mDomain(_domain) {}
