...
class UFInstanceContent {
   ...
   private:
     ...
     */
    explicit UFInstanceContent(const UninterpretedFunction& _uf, std::vector<UVariable>&& _args) : mUninterpretedFunction(_uf), mArgs(std::move(_args)) {}
     ...
     * @param _args The arguments of the uninterpreted function instance to construct.
     */
    explicit UFInstanceContent(const UninterpretedFunction& _uf, const std::vector<UVariable>& _args) : mUninterpretedFunction(_uf), mArgs(_args) {}
...
class UFInstanceManager : public Singleton<UFInstanceManager> {
   ...
   private:
     ...
     */
    UFInstanceManager() : mUFInstanceIdMap(), mUFInstances() {
