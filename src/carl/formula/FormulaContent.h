...
struct QuantifierContent {
     ...
     */
    QuantifierContent(std::vector<carl::Variable>&& _vars, Formula<Pol>&& _formula) : mVariables(std::move(_vars)), mFormula(std::move(_formula)) {}
...
struct ArithmeticConstraintContent {
    ...
    ArithmeticConstraintContent(Formula<Pol>&& _lhs, Relation _rel) : mLhs(std::move(_lhs)), mRelation(_rel) {}
   ...
   public:
    ...
    ~FormulaContent() {
        ...
        switch (mType) {
            ...
            case FormulaType::CONSTRAINT: {
                mpConstraintVS->~Constraint();
                break;
            }
            case FormulaType::VARCOMPARE: {
                mpVariableComparisonVS->~VariableComparison();
                break;
            }
            case FormulaType::BITVECTOR: {
                mpBVConstraintVS->~BVConstraint();
                break;
            }
            case FormulaType::UEQ: {
                mpUIEqualityVS->~UEquality();
                break;
            }
#else
            case FormulaType::ITE: {
            ...
            case FormulaType::VARCOMPARE: {
                mVariableComparison.~VariableComparison();
                break;
            }
            case FormulaType::VARASSIGN: {
                mVariableAssignment.~VariableAssignment();
                break;
            }
            case FormulaType::BITVECTOR: {
                mBVConstraint.~BVConstraint();
                break;
            }
            case FormulaType::UEQ: {
                mUIEquality.~UEquality();
                break;
            }
            case FormulaType::PBCONSTRAINT: {
                mPBConstraint.~PBConstraint();
                break;
            }
#endif
        }
