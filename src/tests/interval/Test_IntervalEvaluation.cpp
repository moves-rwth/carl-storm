...
TEST(IntervalEvaluation, Term) {
    ...
    UnivariatePolynomial<MultivariatePolynomial<Rational>> p(
        b, {MultivariatePolynomial<Rational>(), MultivariatePolynomial<Rational>(), MultivariatePolynomial<Rational>(a * a)});
    Interval<Rational> i1(Rational(0), carl::BoundType::INFTY, Rational(0), carl::BoundType::INFTY);
    Interval<Rational> i2(Rational(0), carl::BoundType::INFTY, Rational(0), carl::BoundType::INFTY);
    map[a] = i1;
    map[b] = i2;
