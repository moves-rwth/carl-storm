...
TEST(MpqInterval, Multiplication) {
    ...
    result = c0.mul(d0);
    EXPECT_EQ(MpqInterval(mpq_class(c0.upper() * d0.upper()), BoundType::WEAK, mpq_class(c0.lower() * d0.lower()), BoundType::WEAK), result);
    result = c0.mul(d5);
    EXPECT_EQ(MpqInterval(mpq_class(c0.upper() * d5.upper()), BoundType::WEAK, mpq_class(c0.lower() * d5.lower()), BoundType::WEAK), result);
    result = c1.mul(d0);
    EXPECT_EQ(MpqInterval(mpq_class(c1.upper() * d0.lower()), BoundType::WEAK, mpq_class(c1.lower() * d0.lower()), BoundType::WEAK), result);
    result = c1.mul(d5);
    EXPECT_EQ(MpqInterval(mpq_class(c1.upper() * d5.lower()), BoundType::WEAK, mpq_class(c1.lower() * d5.lower()), BoundType::WEAK), result);
    result = c2.mul(d0);
    EXPECT_EQ(MpqInterval(mpq_class(c2.upper() * d0.lower()), BoundType::WEAK, mpq_class(c2.lower() * d0.upper()), BoundType::WEAK), result);
    result = c2.mul(d5);
    EXPECT_EQ(MpqInterval(mpq_class(c2.upper() * d5.lower()), BoundType::WEAK, mpq_class(c2.lower() * d5.upper()), BoundType::WEAK), result);
    result = c3.mul(d0);
    ...
    result = c0.mul(d6);
    EXPECT_EQ(MpqInterval(mpq_class(c0.lower() * d6.upper()), BoundType::WEAK, mpq_class(c0.lower() * d6.lower()), BoundType::WEAK), result);
    result = c1.mul(d6);
    EXPECT_EQ(
        MpqInterval(
            (mpq_class(c1.lower() * d6.upper()) < mpq_class(c1.upper() * d6.lower()) ? mpq_class(c1.lower() * d6.upper()) : mpq_class(c1.upper() * d6.lower())),
            BoundType::WEAK,
            mpq_class(c1.lower() * d6.lower()) > mpq_class(c1.upper() * d6.upper()) ? mpq_class(c1.lower() * d6.lower()) : mpq_class(c1.upper() * d6.upper()),
            BoundType::WEAK),
        result);
    result = c2.mul(d6);
    EXPECT_EQ(MpqInterval(mpq_class(c2.upper() * d6.lower()), BoundType::WEAK, mpq_class(c2.upper() * d6.upper()), BoundType::WEAK), result);
    result = c3.mul(d6);
    ...
    result = c0.mul(d1);
    EXPECT_EQ(MpqInterval(mpq_class(c0.lower() * d1.upper()), BoundType::WEAK, mpq_class(c0.upper() * d1.lower()), BoundType::WEAK), result);
    result = c0.mul(d7);
    EXPECT_EQ(MpqInterval(mpq_class(c0.lower() * d7.upper()), BoundType::WEAK, mpq_class(c0.upper() * d7.lower()), BoundType::WEAK), result);
    result = c1.mul(d1);
    EXPECT_EQ(MpqInterval(mpq_class(c1.lower() * d1.upper()), BoundType::WEAK, mpq_class(c1.upper() * d1.upper()), BoundType::WEAK), result);
    result = c1.mul(d7);
    EXPECT_EQ(MpqInterval(mpq_class(c1.lower() * d7.upper()), BoundType::WEAK, mpq_class(c1.upper() * d7.upper()), BoundType::WEAK), result);
    result = c2.mul(d1);
    EXPECT_EQ(MpqInterval(mpq_class(c2.lower() * d1.lower()), BoundType::WEAK, mpq_class(c2.upper() * d1.upper()), BoundType::WEAK), result);
    result = c2.mul(d7);
    EXPECT_EQ(MpqInterval(mpq_class(c2.lower() * d7.lower()), BoundType::WEAK, mpq_class(c2.upper() * d7.upper()), BoundType::WEAK), result);
    result = c3.mul(d1);
    EXPECT_EQ(MpqInterval(0), result);
    result = c3.mul(d7);
    EXPECT_EQ(MpqInterval(0), result);
...
TEST(MpqInterval, ExtendedDivision) {
    ...
    EXPECT_EQ(MpqInterval(mpq_class(a0.upper() / b0.lower()), BoundType::WEAK, mpq_class(a0.lower() / b0.upper()), BoundType::WEAK), result1);
    a1.div_ext(b0, result1, result2);
    EXPECT_EQ(MpqInterval(mpq_class(a1.upper() / b0.upper()), BoundType::WEAK, mpq_class(a1.lower() / b0.upper()), BoundType::WEAK), result1);
    a2.div_ext(b0, result1, result2);
    EXPECT_EQ(MpqInterval(mpq_class(a2.upper() / b0.upper()), BoundType::WEAK, mpq_class(a2.lower() / b0.lower()), BoundType::WEAK), result1);
    ...
    EXPECT_EQ(MpqInterval(mpq_class(a0.lower() / b1.lower()), BoundType::WEAK, mpq_class(a0.upper() / b1.upper()), BoundType::WEAK), result1);
    a1.div_ext(b1, result1, result2);
    EXPECT_EQ(MpqInterval(mpq_class(a1.lower() / b1.lower()), BoundType::WEAK, mpq_class(a1.upper() / b1.lower()), BoundType::WEAK), result1);
    a2.div_ext(b1, result1, result2);
    EXPECT_EQ(MpqInterval(mpq_class(a2.lower() / b1.upper()), BoundType::WEAK, mpq_class(a2.upper() / b1.lower()), BoundType::WEAK), result1);
    ...
    EXPECT_EQ(MpqInterval(mpq_class(a1.upper() / b2.upper()), BoundType::WEAK, mpq_class(a1.lower() / b2.upper()), BoundType::WEAK), result1);
    ...
    EXPECT_EQ(MpqInterval(mpq_class(a1.lower() / b3.lower()), BoundType::WEAK, mpq_class(a1.upper() / b3.lower()), BoundType::WEAK), result1);
...
TEST(MpqInterval, Union) {
    ...
    EXPECT_EQ(MpqInterval(3, BoundType::STRICT, 3, BoundType::INFTY), result1);
    EXPECT_EQ(MpqInterval(-2, BoundType::WEAK, 1, BoundType::WEAK), result2);
}
