...
TEST(MultivariatePolynomial, toUnivariatePolynomial) {
    ...
    }
    {
        ...
        UnivariatePolynomial<MultivariatePolynomial<Rational>> res(
            x, {MultivariatePolynomial<Rational>((Rational)0), MultivariatePolynomial<Rational>((Rational)1 * y),
                MultivariatePolynomial<Rational>((Rational)-1), MultivariatePolynomial<Rational>((Rational)3)});
...
TEST(MultivariatePolynomial, Substitute) {
    ...
    MultivariatePolynomial<Rational> f1({(Rational)1 * x * x * v * x * y * y, (Rational)-2 * x * x * y * y * y, (Rational)312347 * v * v * x,
                                         (Rational)3 * y * v * z * z * x, Term<Rational>((Rational)1)});
    ...
    MultivariatePolynomial<Rational> f2({(Rational)7 * x * x * x * x * y * y, (Rational)191 * x * x * x * x * z * z * z, (Rational)-3 * x * x * y,
                                         (Rational)1 * z * z * x * v * v, (Rational)2 * z * y * v * v, Term<Rational>((Rational)4)});
    GiNaC::ex f2g =
        7 * xg * xg * xg * xg * yg * yg + 191 * xg * xg * xg * xg * zg * zg * zg - 3 * xg * xg * yg + zg * zg * xg * vg * vg + 2 * zg * yg * vg * vg + 4;
...
TEST(MultivariatePolynomial, Quotient2) {
    ...
    MultivariatePolynomial<Rational> p1 = sp.parseMultivariatePolynomial<Rational>(
        "t^3*u^6+(-3)*t*u^5+(-1)*u^6+(-3)*t^2*u^6+3*t*u^6+(-1)*t^3*u^5+(-1)*t^3+(-3)*t+3*t^2+(-3)*u+3*t^3*u+9*t*u+(-9)*t^2*u+5*u^2+(-5)*t^3*u^2+(-15)*t*u^2+15*"
        "t^2*u^2+3*t^2*u^4+(-3)*t*u^4+(-1)*t^3*u^4+(-4)*u^3+u^4+(-12)*t^2*u^3+12*t*u^3+4*t^3*u^3+u^5+3*t^2*u^5+1");
...
TYPED_TEST(MultivariatePolynomialTest, MultivariatePolynomialMultiplication) {
    ...
    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)12 * x * x * x * x * x * y, (TypeParam)6 * x * x * x * y * y * y, (TypeParam)27 * x * x * y * y,
                                                 (TypeParam)28 * x * x * x * x * y, (TypeParam)14 * x * x * y * y * y, (TypeParam)63 * x * y * y}),
              MultivariatePolynomial<TypeParam>({(TypeParam)3 * x * x * y, (TypeParam)7 * x * y}) *
                  MultivariatePolynomial<TypeParam>({(TypeParam)4 * x * x * x, (TypeParam)2 * x * y * y, (TypeParam)9 * y}));

    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)30 * x * y * y, (TypeParam)18 * x * y * y * y, (TypeParam)8 * x * y}),
              MultivariatePolynomial<TypeParam>({(TypeParam)3 * x * y, (TypeParam)4 * x}) *
                  MultivariatePolynomial<TypeParam>({(TypeParam)2 * y, (TypeParam)6 * y * y}));

    EXPECT_EQ(
        MultivariatePolynomial<TypeParam>({(TypeParam)12 * x * y, (TypeParam)21 * x, (TypeParam)8 * y, Term<TypeParam>(14)}),
    ...
    EXPECT_EQ(
        MultivariatePolynomial<TypeParam>({(TypeParam)1 * x * x, (TypeParam)-1 * y * y}),
    ...
    EXPECT_EQ(
        MultivariatePolynomial<TypeParam>({(TypeParam)1 * x * x, (TypeParam)2 * x * y, (TypeParam)1 * y * y}),
        MultivariatePolynomial<TypeParam>({(TypeParam)1 * x, (TypeParam)1 * y}) * MultivariatePolynomial<TypeParam>({(TypeParam)1 * x, (TypeParam)1 * y}));
    ...
    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)8 * x * x * y, (TypeParam)6 * x * y, (TypeParam)9 * x * y * y}),
              MultivariatePolynomial<TypeParam>({(TypeParam)1 * x * y}) *
                  MultivariatePolynomial<TypeParam>({(TypeParam)8 * x, Term<TypeParam>(6), (TypeParam)9 * y}));
}
...
TYPED_TEST(MultivariatePolynomialTest, CreationViaOperators) {
    ...
    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)5 * x * y, (TypeParam)7 * y, (TypeParam)11 * x * x}),
              (TypeParam)5 * x * y + (TypeParam)7 * y + (TypeParam)11 * x * x);
    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)1 * x, (TypeParam)1 * y}), (TypeParam)1 * x + (TypeParam)1 * y);
    EXPECT_EQ(MultivariatePolynomial<TypeParam>({(TypeParam)8 * x * x * y, (TypeParam)6 * x * y, (TypeParam)9 * x * y * y}),
              (TypeParam)3 * x * x * y + (TypeParam)4 * x * y + (TypeParam)9 * x * y * y + (TypeParam)2 * x * y + (TypeParam)5 * x * x * y);
}
...
TEST(MultivariatePolynomialTest, Definiteness) {
    ...
    MultivariatePolynomial<Rational> p1(
        {(Rational)6 * x * x, (Rational)49 * y * y, (Rational)51 * z * z, (Rational)-82 * y * z, (Rational)20 * x * z, (Rational)-4 * x * y});
    ...
    MultivariatePolynomial<Rational> p5({(Rational)30156 * w * w, (Rational)-79766 * w * x, (Rational)62266 * w * y, (Rational)61172 * w * z,
                                         (Rational)100000 * x * x, (Rational)-80312 * x * y, (Rational)-100000 * x * z, (Rational)33867 * y * y,
                                         (Rational)55312 * y * z, (Rational)100000 * z * z});
