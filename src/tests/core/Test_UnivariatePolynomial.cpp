...
TEST(UnivariatePolynomial, Reduction) {
    ...
    }
    {
        UnivariatePolynomial<MultivariatePolynomial<Rational>> p(
            x, {MultivariatePolynomial<Rational>(1), MultivariatePolynomial<Rational>(1), MultivariatePolynomial<Rational>(0),
                MultivariatePolynomial<Rational>(0), MultivariatePolynomial<Rational>(1)});
...
TYPED_TEST(UnivariatePolynomialIntTest, primitivePart) {
    ...
    EXPECT_EQ(UnivariatePolynomial<TypeParam>(x, {1, 2, 3}), UnivariatePolynomial<TypeParam>(x, {-1, -2, -3}).normalized().primitivePart());
    EXPECT_EQ(UnivariatePolynomial<TypeParam>(x, {5, 9, 1}),
              UnivariatePolynomial<TypeParam>(x, {-15, -27, -3}).normalized().primitivePart().normalized().primitivePart());
}
...
TEST(UnivariatePolynomial, resultant) {
    ...
    // p2 = x^2 + y^2 - 1
    UnivariatePolynomial<MultivariatePolynomial<Rational>> p2(x, {MultivariatePolynomial<Rational>({Term<Rational>(y) * y, Term<Rational>(-1)}),
                                                                  MultivariatePolynomial<Rational>(0), MultivariatePolynomial<Rational>(1)});
    // p3 = x^2 - 1
    UnivariatePolynomial<MultivariatePolynomial<Rational>> p3(
        x, {MultivariatePolynomial<Rational>(-Term<Rational>(1)), MultivariatePolynomial<Rational>(0), MultivariatePolynomial<Rational>(1)});
