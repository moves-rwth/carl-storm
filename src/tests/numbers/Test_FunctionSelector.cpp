...
TEST(FunctionSelector, basic) {
    ...
    using TypeSelector = carl::function_selector::NaryTypeSelector;
    auto s = carl::createFunctionSelector<TypeSelector, types>([](const mpz_class& n) { return carl::isZero(n); },
...
TEST(FunctionSelector, binary) {
    using TypeSelector = carl::function_selector::NaryTypeSelector;
    using types = carl::function_selector::wrap_types<mpz_class, mpq_class>;
    auto s = carl::createFunctionSelector<TypeSelector, types>([](const mpz_class& n1, const mpz_class& n2) { return carl::isZero(mpz_class(n1 + n2)); },
